...
class BotMessages:
    ...
    START_COMMAND_MESSAGE = (
        ...
        "⚠️⚠️⚠️Please manage the risk carefully. We are not responsible for any loss. These signals are generated by artificial intelligence. They may not be accurate every time!!! ⚠️⚠️⚠️\n\n"
    )
